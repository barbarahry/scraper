...
$.getJSON("/articles", function(data) {
  ...
  for (var i = 0; i < data.length; i++) {
   ...
   // $("#articles").append("<br />" + data[i].pbody);
    $("#articles").append("<a href="+ fullLink +"><h6 class='mb-0' data-id='" + data[i]._id + "'>" + data[i].title +"</h6></a><p>" + data[i].pbody + "</p><br /><a class='btn btn-sm btn-outline-warning mr-3 deletearticle' data-id='" + data[i]._id + "'href='#'>Delete Article</a><a class='btn btn-sm btn-outline-success seenotes' data-id='" + data[i]._id + "'href='#'>Article Notes</a><hr>");
